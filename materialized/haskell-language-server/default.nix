  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hls-floskell-plugin".revision = (((hackage."hls-floskell-plugin")."1.0.1.1").revisions).default;
        ...
        "ormolu".revision = (((hackage."ormolu")."0.4.0.0").revisions).default;
        "ormolu".flags.dev = false;
        "hls-change-type-signature-plugin".revision = (((hackage."hls-change-type-signature-plugin")."1.0.1.0").revisions).default;
        ...
        "lsp".revision = (((hackage."lsp")."1.4.0.0").revisions).default;
        ...
        "hls-retrie-plugin".revision = (((hackage."hls-retrie-plugin")."1.0.2.1").revisions).default;
        ...
        "hlint".revision = (((hackage."hlint")."3.3.6").revisions).default;
        ...
        "hls-refine-imports-plugin".revision = (((hackage."hls-refine-imports-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-graph".revision = (((hackage."hls-graph")."1.7.0.0").revisions).default;
        ...
        "hls-fourmolu-plugin".revision = (((hackage."hls-fourmolu-plugin")."1.0.3.0").revisions).default;
        ...
        "hls-plugin-api".revision = (((hackage."hls-plugin-api")."1.4.0.0").revisions).default;
        ...
        "lens-aeson".revision = (((hackage."lens-aeson")."1.2.1").revisions).default;
        ...
        "hls-hlint-plugin".revision = (((hackage."hls-hlint-plugin")."1.0.4.0").revisions).default;
        "hls-hlint-plugin".flags.hlint33 = true;
        ...
        "ghcide".revision = (((hackage."ghcide")."1.7.0.0").revisions).default;
        ...
        "enummapset".revision = (((hackage."enummapset")."0.6.0.3").revisions).default;
        ...
        "hls-ormolu-plugin".revision = (((hackage."hls-ormolu-plugin")."1.0.2.1").revisions).default;
        ...
        "hls-call-hierarchy-plugin".revision = (((hackage."hls-call-hierarchy-plugin")."1.0.3.0").revisions).default;
        ...
        "hls-rename-plugin".revision = (((hackage."hls-rename-plugin")."1.0.0.2").revisions).default;
        ...
        "hls-explicit-imports-plugin".revision = (((hackage."hls-explicit-imports-plugin")."1.1.0.0").revisions).default;
        ...
        "hls-module-name-plugin".revision = (((hackage."hls-module-name-plugin")."1.0.2.0").revisions).default;
        "ghc-paths".revision = (((hackage."ghc-paths")."0.1.0.12").revisions).default;
        "lsp-test".revision = (((hackage."lsp-test")."0.14.0.2").revisions).default;
        "text-short".revision = (((hackage."text-short")."0.1.5").revisions).default;
        "text-short".flags.asserts = false;
        "hls-haddock-comments-plugin".revision = (((hackage."hls-haddock-comments-plugin")."1.0.1.0").revisions).default;
        ...
        "hls-eval-plugin".revision = (((hackage."hls-eval-plugin")."1.2.2.0").revisions).default;
        ...
        "hls-splice-plugin".revision = (((hackage."hls-splice-plugin")."1.0.1.0").revisions).default;
        ...
        "lsp-types".revision = (((hackage."lsp-types")."1.4.0.1").revisions).default;
        "exceptions".revision = (((hackage."exceptions")."0.10.4").revisions).default;
        "hls-qualify-imported-names-plugin".revision = (((hackage."hls-qualify-imported-names-plugin")."1.0.1.0").revisions).default;
        ...
        "hie-bios".revision = (((hackage."hie-bios")."0.9.1").revisions).default;
        ...
        "hls-pragmas-plugin".revision = (((hackage."hls-pragmas-plugin")."1.0.2.1").revisions).default;
        ...
        "hls-alternate-number-format-plugin".revision = (((hackage."hls-alternate-number-format-plugin")."1.1.0.0").revisions).default;
        "hls-class-plugin".revision = (((hackage."hls-class-plugin")."1.0.3.0").revisions).default;
        ...
        "fourmolu".revision = (((hackage."fourmolu")."0.5.0.1").revisions).default;
        ...
        "hls-selection-range-plugin".revision = (((hackage."hls-selection-range-plugin")."1.0.0.0").revisions).default;
        ...
        packages = {
          "haskell-language-server" = {
            flags = {
              ...
              "selectionrange" = lib.mkOverride 900 true;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hls-selection-range-plugin".components.library.planned = lib.mkOverride 900 true;
